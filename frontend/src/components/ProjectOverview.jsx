  ...
  const exportToPPTX = () => {
    ...
    pptx.defineSlideMaster({
      ...
      objects: [
        ...
        { rect: { x: 0, y: 0.8, w: 13.3, h: 0.02, fill: { color: "334155" } } },
        { text: { text: reportTitle, options: { x: 0.5, y: 0.15, w: 9, h: 0.5, fontSize: 18, color: "34D399", bold: true, fontFace: "Calibri" } } },
        { text: { text: headerInfo, options: { x: 8.5, y: 0.25, w: 4.3, h: 0.4, fontSize: 9.5, color: "94A3B8", align: "right", fontFace: "Calibri" } } }
      ]
    });
